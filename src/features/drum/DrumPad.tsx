...
export function DrumPad(props: any) {
    ...
    return (
        <div className="col">
            <button className={'drum-pad btn w-100 h-100 text-center ' + (arrBtnColours[props.index] || '')}
                ...
                <audio className="clip" id={props.audio.audioId} src={props.audio.audioUrl}></audio>
                {props.audio.audioId}
            </button>
        </div>
    )
